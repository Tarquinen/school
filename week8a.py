...
def getInput(service, typeCleaningStr, options):
    ...
    if service == 'house':
        while True:
            typeCleaning = input(typeCleaningStr) # get user input for types of cleaning they want
    ...
    # Get all the relevant user input if they ask for a yard service            
        ...
        yardShape = None # yes if square/rectangle, no if not
        yardPerimeter = None # perimeter of the yard in feet
        yardArea = None # area of the yard in feet
        ...
        # only ask about shrubs if its a service they requested    
        ...
        return uniqueArray, yardShape, yardArea, yardPerimeter, shrubCount
...
def houseCleaning():
    ...
    print(f'The total cost of the {servicesString} house service is', cost, 'dollars')
...
def yardService():
    ...
    services, yardShape, yardArea, yardPerimeter, shrubCount = getInput('yard', typeCleaningStr, options) # store user inputs from getInput function into numRooms and services variables
    servicesString = ', '.join(services) # converts services array into a string for later printing
    ...
    print(f'The total cost of the {servicesString} yard service is', cost, 'dollars')




# this function evaluates costs for house service
...
# this function evaluates costs for yard service
...
def main():
    ...
    while True:
        try:
            serviceType = input()
            if serviceType != 'house' and serviceType != 'yard': # only accept "house" and "yard" input
                raise ValueError()
            break
        except ValueError as ve:
